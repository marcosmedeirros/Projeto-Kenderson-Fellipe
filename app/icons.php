...
// Ícones Lucide (https://lucide.dev, licença ISC), embutidos para não depender de CDN.
// Gerado a partir do pacote lucide-static.
const ICONS = [
...
{
    return '<svg class="' . htmlspecialchars($class, ENT_QUOTES) . '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' . (ICONS[$name] ?? '') . '</svg>';
}
